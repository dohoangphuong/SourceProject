    ...
    public partial class Form1 : Form
    {
        ...
        public void DieuKienThucHien()
        {
            try
            {
                ...
                webBrowser1.Navigate("http://online1.buh.edu.vn/Portlets/UIS_MySpace/Student/Register/RegisterClassStudyUnit.aspx?ID=Jmhj+sFxcbwFJgn+Kcj9/zutmXZ2Brz/DUXZtTlVQM54mKLTi5RP/+GNoNyFt1YUSbCkpTyKirU=");
            ...
            {
                txtSoLuong.Text = "Trang không thể tải";
            }
        }
        ...
        {            
           ...
           // timer1.Interval += 100;
            //txtChiTiet.Text = (timer1.Interval - Int32.Parse(txtChiTiet.Text)).ToString();
        }
    }
}
